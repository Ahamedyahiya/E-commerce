...
const styles = {
  ...
  infoIcon: { fontSize: '2rem', marginBottom: '0.8rem' },
  infoTitle: { color: '#e67e22', fontSize: '1rem', fontWeight: '700', marginBottom: '0.5rem' },
  infoLine: { color: '#aaa', fontSize: '0.88rem', lineHeight: '1.7' },
  mainSection: {
    display: 'flex',
    gap: '3rem',
    padding: '5rem 6rem',
  ...
  formBox: { flex: 1.2, minWidth: '300px' },
  sectionLabel: {
    fontSize: '0.72rem',
    letterSpacing: '0.2em',
    textTransform: 'uppercase',
  ...
  hoursRow: { display: 'flex', justifyContent: 'space-between', marginBottom: '0.6rem' },
  ...
  faqSection: { padding: '5rem 6rem', background: '#f8f8f8' },
